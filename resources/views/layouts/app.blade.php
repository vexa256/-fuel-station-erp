                    ...
                    <div class="top-dropdown user-dropdown" id="user-dropdown">
                        <div class="p-4 border-b border-border">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="font-medium text-sm text-foreground">System Admin</p>
                                    <p class="text-xs text-muted-foreground">admin@fuelstation.com</p>
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-secondary text-secondary-foreground mt-1">
                                        ADMIN
                                    </span>
                                </div>
                            </div>
